...
export default function userProfile() {
  ...
  return (
    <SafeAreaView className="h-full bg-[#6557ec] flex">
      ...
      <View className="items-center h-full bg-white rounded-t-3xl mt-10 pt-5">
        <View className="flex-row w-full h-[4rem] mx-5 border-b-2 border-gray-300 my-3">
          ...
          <View className="pl-5 flex-1 pb-2">
            <View>
              ...
              <Text className="text-md font-bold text-gray-900 mt-1">
                Home lander
              </Text>
            </View>
          </View>
        ...
        <View className="flex-row w-full h-[4rem] mx-5 border-b-2 border-gray-300 my-3">
          ...
          <View className="pl-5 flex-1 pb-2">
            <View>
              <Text className="text-md font-semibold text-gray-700">Email</Text>
              <Text className="text-md font-bold text-gray-900 mt-1">
                bajex@jason.com
              </Text>
            </View>
